...
public class TemplateCompilationException extends TemplateException {
    ...
    public TemplateCompilationException(Template template, String message) {
        this(template, message, null);
    }

    public TemplateCompilationException(Template template, String message, Throwable cause) {
