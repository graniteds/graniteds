...
public class TemplateExecutionException extends TemplateException {
    ...
    public TemplateExecutionException(Template template, String message) {
        this(template, message, null);
    }

    public TemplateExecutionException(Template template, Throwable cause) {
        this(template, null, cause);
    }

    public TemplateExecutionException(Template template, String message, Throwable cause) {
