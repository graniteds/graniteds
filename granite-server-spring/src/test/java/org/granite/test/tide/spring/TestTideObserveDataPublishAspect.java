...
@ContextConfiguration(locations={ "/org/granite/test/tide/spring/test-context-observe-aspectj.xml" })
public class TestTideObserveDataPublishAspect extends AbstractTideInterceptorTestCase {
