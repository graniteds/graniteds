...
/**
 * 	Implementation of PersistenceAdapterFactory for Spring
	...
	public TidePersistenceAdapter newPersistenceAdapter() {
		if (transactionManager instanceof HibernateTransactionManager) {
			try {
				...
				return (TidePersistenceAdapter)ClassUtil.newInstance("org.granite.tide.hibernate.HibernatePersistenceAdapter", 
