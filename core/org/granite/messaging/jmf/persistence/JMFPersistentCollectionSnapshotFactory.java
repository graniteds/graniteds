...
public class JMFPersistentCollectionSnapshotFactory extends PersistentCollectionSnapshotFactory {
	...
	public PersistentCollectionSnapshot newPersistentCollectionSnapshot(boolean sorted) {
		return new JMFPersistentCollectionSnapshot(sorted);
	}

	@Override
	public PersistentCollectionSnapshot newPersistentCollectionSnapshot(boolean initialized, boolean dirty, Collection<?> collection) {
		return new JMFPersistentCollectionSnapshot(initialized, dirty, collection);
	}

	@Override
	public PersistentCollectionSnapshot newPersistentCollectionSnapshot(boolean initialized, boolean dirty, Map<?, ?> collection) {
		return new JMFPersistentCollectionSnapshot(initialized, dirty, collection);
	}
}
