...
public class ExternalizablePersistentBag extends ExternalizablePersistentList {
	...
	public ExternalizablePersistentBag(List<?> content, boolean initialized, boolean dirty) {
		super(content, initialized, dirty);
	}
    
	public ExternalizablePersistentBag(Object[] content, boolean initialized, boolean dirty) {
		super(content, initialized, dirty);
	}
}
