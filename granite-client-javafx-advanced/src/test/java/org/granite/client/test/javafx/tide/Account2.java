...
@Entity
@RemoteAlias("org.granite.test.tide.Account2")
public class Account2 extends AbstractEntity {
    ...
    public Account2(Long id, Long version, String uid, String name) {
        super(id, version, uid);
        this.name.set(name);
    }

    public Account2(Long id, boolean initialized, String detachedState) {
