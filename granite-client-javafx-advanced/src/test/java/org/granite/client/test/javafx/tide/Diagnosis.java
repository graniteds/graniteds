...
public class Diagnosis extends AbstractEntity {
    ...
    public Diagnosis(Long id, Long version, String uid, Patient4 patient, Visit2 visit, String name) {
    ...
    public Diagnosis(Long id, boolean initialized, String detachedState) {
