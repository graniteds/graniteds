...
@Entity
@RemoteAlias("org.granite.test.tide.Patient5")
public class Patient5 extends AbstractEntity {

	private static final long serialVersionUID = 1L;
	
    @Lazy
    private ReadOnlySetWrapper<Consent> consents = FXPersistentCollections.readOnlyObservablePersistentSet(this, "consents");
    ...
    public Patient5(Long id, Long version, String uid, String name) {
        super(id, version, uid);
        this.name.set(name);
    }

    public Patient5(Long id, boolean initialized, String detachedState) {
