...
* __granite.jar__: You may take it from any of the GraniteDS sample applications or from GraniteDS source distribution in the +libraries/server+ folder. 
...
Create a new folder named +lib+ at the root of the project and put +granite.jar+ into this new folder. Create a new file named +build.xml+ at the root of the project. 
...
* __granite.jar__: You may take it from the GraniteDS distribution in the +libraries/server+ folder. 
    Download it link:$$http://www.graniteds.org/confluence/display/DOWNLOAD$$[here].             
* _granite-client.jar_: You may take it from any of the GraniteDS sample applications or from GraniteDS source distribution in the +libraries/java-client+ folder. 
    Download it link:$$http://www.graniteds.org/confluence/display/DOWNLOAD$$[here].             
...
Create a folder named +lib+ at the root of the project and put +granite.jar+ in this folder. Create a new file named +build.xml+ at the root of the 
...
This is the initialization part of the GraniteDS Java client. It requires creating a transport (here the default transport based on the Apache 
asynchronous HTTP client), a remoting channel and a +RemoteService+ whose target destination matches the destination we declared earlier in the server configuration. 
...
* _granite.jar_, _granite-hibernate.jar_: You may take it from GraniteDS distribution in the +libraries/server+ folder. 
    Download it link:$$http://www.graniteds.org/confluence/display/DOWNLOAD$$[here].             
* _granite-flex45.swc_, _granite-essentials.swc_: You may take it from GraniteDS distribution in the +libraries/flex-client+ folder. 
    Download it link:$$http://www.graniteds.org/confluence/display/DOWNLOAD$$[here].             
...
Create a new directory named +lib+ at the root of this project and put +granite.jar+, +granite-hibernate.jar+, +granite-flex45.swc+ and +granite-essentials.swc+ 
into it. Also add these two JBoss jars: +ejb3-persistence.jar+ and +jboss-ejb3x.jar+, which you will find in the +/jboss-4.2.3.GA/server/default/lib+ directory. 
