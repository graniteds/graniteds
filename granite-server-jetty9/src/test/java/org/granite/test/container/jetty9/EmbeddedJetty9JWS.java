 ...
 */
public class EmbeddedJetty9JWS extends EmbeddedJetty9 {

    public EmbeddedJetty9JWS(WebArchive war, boolean persistSessions) throws Exception {
    ...
    protected void initWar(WebArchive war) {
        ...
        war.setWebXML(new File("granite-server-jetty9/src/test/resources/web-websocket-std.xml"));
    }
}
