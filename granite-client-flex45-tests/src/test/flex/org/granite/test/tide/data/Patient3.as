...
package org.granite.test.tide.data {
    ...
    [Managed]
    [RemoteClass(alias="org.granite.test.tide.Patient3")]
    public class Patient3 extends AbstractEntity {
        ...
        override public function writeExternal(output:IDataOutput):void {
            ...
            if (meta::isInitialized()) {
				...
				output.writeObject((_visits is IPropertyHolder) ? IPropertyHolder(_visits).object : _visits);
            }
        }
    }
}
