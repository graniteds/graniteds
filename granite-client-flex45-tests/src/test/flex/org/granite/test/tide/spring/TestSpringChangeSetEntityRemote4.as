...
package org.granite.test.tide.spring
{
    ...
    public class TestSpringChangeSetEntityRemote4 {
        ...
        [Test(async)]
		public function testChangeSetEntityRemote5():void {
		...
		[Test(async)]
		public function testChangeSetEntityRemote6():void {
			var patient:Patient5 = new Patient5();
			patient.uid = "P1";
			patient.id = 1;
			patient.version = 0;
		...
		private function result2Handler(event:TideResultEvent, pass:Object = null):void {			
			...
			_ctx.tideService.removeDocuments(Async.asyncHandler(this, result3Handler, 1000, pass));
		}
...
class MockSimpleCallAsyncToken extends MockSpringAsyncToken {
	...
	protected override function buildResponse(call:InvocationCall, componentName:String, op:String, params:Array):AbstractEvent {
		...
		if (componentName == "tideService" && op.indexOf("applyChangeSet") == 0) {
			...
			var docListRef:ChangeRef = new ChangeRef(Type.forClass(DocumentList).name, consent.documentList.uid, consent.documentList.id);
			
			var change:Change = new Change(Type.forClass(Consent).name, consent.uid, consent.id, 1);
			change.changes.documentList = null;
			
			return buildResult(null, null, [[ 'UPDATE', change ], [ 'REMOVE', docListRef ]]);
		}
