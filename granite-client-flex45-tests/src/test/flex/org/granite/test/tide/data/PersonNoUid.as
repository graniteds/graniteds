...
package org.granite.test.tide.data {
    ...
    import org.granite.test.tide.AbstractEntityNoUid;
    import org.granite.test.tide.AbstractEntityNoVersion;
    ...
    [Managed]
    [RemoteClass(alias="org.granite.test.tide.data.PersonNoUid")]
    public class PersonNoUid extends AbstractEntityNoUid {
		...
		public function PersonNoUid(id:Number = NaN, name:String = null):void {
			super(id);
			_lastName = name;
		}
        ...
        override meta function merge(em:IEntityManager, obj:*):void {
            var src:PersonNoUid = PersonNoUid(obj);
