...
package org.granite.test.tide.data {
	...
	[Managed]
    [RemoteClass(alias="org.granite.test.tide.data.Contact3b")]
    public class Contact3b extends AbstractEntityLong {

        private var _email:String;
        private var _person:Person9b;
        ...
        public function set person(value:Person9b):void {
            _person = value;
        }
        [Lazy]
        public function get person():Person9b {
            return _person;
        }

       	override meta function merge(em:IEntityManager, obj:*):void {
            var src:Contact3b = Contact3b(obj);
            super.meta::merge(em, obj);
            if (meta::isInitialized()) {
               	em.meta_mergeExternal(src._email, _email, null, this, 'email', function setter(o:*):void{_email = o as String}, false);
                em.meta_mergeExternal(src._person, _person, null, this, 'person', function setter(o:*):void{_person = o as Person9b}, false);
            }
        }
        ...
        override public function readExternal(input:IDataInput):void {
            ...
            if (meta::isInitialized()) {
                ...
                _person = input.readObject() as Person9b;
            }
        }
