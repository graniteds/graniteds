...
package org.granite.test.tide.data {
	...
	[Managed]
    [RemoteClass(alias="org.granite.test.tide.data.ContactNoUid")]
    public class ContactNoUid extends AbstractEntityNoUid {

        private var _email:String;
        private var _person:PersonNoUid;

		public function ContactNoUid(id:Number = NaN, email:String = null):void {
			super(id);
			_email = email;
		}
        ...
        public function set person(value:PersonNoUid):void {
            _person = value;
        }
        [Lazy]
        public function get person():PersonNoUid {
            return _person;
        }

       	override meta function merge(em:IEntityManager, obj:*):void {
            var src:ContactNoUid = ContactNoUid(obj);
            super.meta::merge(em, obj);
            if (meta::isInitialized()) {
               	em.meta_mergeExternal(src._email, _email, null, this, 'email', function setter(o:*):void{_email = o as String});
                em.meta_mergeExternal(src._person, _person, null, this, 'person', function setter(o:*):void{_person = o as PersonNoUid});
            }
        }
        ...
        override public function readExternal(input:IDataInput):void {
            ...
            if (meta::isInitialized()) {
                ...
                _person = input.readObject() as PersonNoUid;
            }
        }
