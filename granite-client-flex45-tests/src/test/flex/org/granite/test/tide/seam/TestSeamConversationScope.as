...
package org.granite.test.tide.seam
{
    ...
    public class TestSeamConversationScope
    {
        ...
        private function selectResult(event:TideResultEvent, pass:Object = null):void {
            ...
            Assert.assertEquals(event.context, component.meta_context);
			Assert.assertTrue(MockSeam.getInstance().isComponentInEvent(component.meta_name));
        }
    }
}
