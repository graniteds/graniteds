...
package org.granite.test.tide.data
{
    ...
    public class TestDirtyCheckEntityBidir
    {
        ...
        [Test]
        public function testDirtyCheckEntityBidir():void {
			...
			child2.superclasses.addItem(parent2);
		...
		[Test]
		public function testDirtyCheckEntityBidir2():void {
			var parent:Classification = new Classification();
			parent.id = 1;
			parent.version = 0;
			parent.uid = "P1";
			...
			Assert.assertTrue("Classification merged still dirty", _ctx.meta_dirty);
			Assert.assertTrue("Parent dirty", _ctx.meta_isEntityChanged(parent));
			Assert.assertFalse("Child not dirty", _ctx.meta_isEntityChanged(child));
        }
		
		
		[Test]
		public function testDirtyCheckEntityBidir3():void {
			var parent:Classification = new Classification();
			parent.id = 1;
			parent.version = 0;
			parent.uid = "P1";
			...
			_ctx.meta_mergeExternal(parent2);
			
			Assert.assertTrue("Classification merged still dirty", _ctx.meta_dirty);
			Assert.assertFalse("Parent dirty", _ctx.meta_isEntityChanged(parent));
			Assert.assertTrue("Child dirty", _ctx.meta_isEntityChanged(child));
		}
    }
}
