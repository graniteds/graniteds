 ...
 * @author Franck WOLFF
 */
public class IndirectSetCodec extends AbstractPersistentCollectionCodec<IndirectSet> {

	public IndirectSetCodec() {
		super(IndirectSet.class);
	}

	public IndirectSet newInstance(ExtendedObjectInput in, String className)
		...
		if (snapshot.isInitialized())
			return new IndirectSet(new HashSet<Object>());
		
		IndirectSet collection = new IndirectSet();
