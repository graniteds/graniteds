package org.granite.tide.test.data
{
    ...
    public class TestMergeCollectionOfEntities extends TestCase
    {
        public function TestMergeCollectionOfEntities() {
            super("testMergeCollectionOfEntities");
        }
        ...
        public function testMergeCollectionOfEntities():void {
        	...
        	assertEquals("Collection merged", 3, person.contacts.length);
        }
    }
}
