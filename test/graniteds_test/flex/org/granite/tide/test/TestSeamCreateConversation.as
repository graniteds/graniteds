package org.granite.tide.test
{
    ...
    public class TestSeamCreateConversation extends TestCase
    {
        public function TestSeamCreateConversation() {
            super("testSeamCreateConversation");
        }
        ...
        private function selectResult(event:TideResultEvent):void {
            ...
            assertEquals("toto", event.context.user.username);
        }
    }
}
