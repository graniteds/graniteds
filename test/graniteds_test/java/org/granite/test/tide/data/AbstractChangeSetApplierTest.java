...
import org.granite.test.tide.data.Person1.Salutation;
...
public abstract class AbstractChangeSetApplierTest {
	...
	public void testSimpleChanges() throws Exception {
		...
		Person1 p2 = (Person1)newProxy(Person1.class, personId);
		...
		for (Contact1 c : pc3.getContacts())
			Assert.assertTrue("Changed person 3 coll element", pc3 == c.getPerson());
