...
public abstract class AbstractHibernate3ChangeSetPublisherTest {
	...
	@Ignore("Cannot make this kind of mapping work with Hibernate: @OneToMany(mappedBy='bla', orphanRemove=true) + @OrderColumn")
	@Test
