...
package org.granite.gravity.channels.udp {
	 ...
	 * are performed through a secure (encrypted) HTTPS channel.
	 *  
	 * @author Franck WOLFF
	 * 
	 * @see UdpGravityChannel
	 */
    public class UdpSecureGravityChannel extends UdpGravityChannel {

        public function UdpSecureGravityChannel(id:String, uri:String) {
            super(id, uri);
        }
