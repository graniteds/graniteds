...
package org.granite.example.addressbook.cdi {
    ...
    import org.granite.example.addressbook.cdi.ctl.*;
    import org.granite.example.addressbook.entity.Person;
    import org.granite.example.addressbook.cdi.service.PeopleService;
    ...
    public class AddressBookModule implements ITideModule {
        ...
        public function init(tide:Tide):void {
            ...
            t.filters = ["org.granite.tide.collections.*"];
            Log.addTarget(t);
            ...
            tide.addComponentWithFactory("peopleService", PagedQuery, 
            	{ filterClass: Person, elementClass: Person, remoteComponentClass: PeopleService }, false, true, Tide.RESTRICT_YES);
