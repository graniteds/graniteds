...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <mbean code="org.jboss.resource.connectionmanager.TxConnectionManager"
      ...
      <xsl:choose>
        <xsl:when test="wrap-xa-resource">
          <attribute name="WrapXAResource">
            <xsl:value-of select="normalize-space(wrap-xa-resource)"/>
          </attribute>
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:choose>
        <xsl:when test="pad-xid">
          <attribute name="PadXid">
            <xsl:value-of select="normalize-space(pad-xid)"/>
          </attribute>
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:if test="isSameRM-override-value">
        <config-property name="IsSameRMOverrideValue" type="java.lang.Boolean">
          <xsl:value-of select="normalize-space(isSameRM-override-value)"/>
        </config-property>
      </xsl:if>

      <xsl:if test="xa-resource-timeout">
        <attribute name="XAResourceTransactionTimeout">
          <xsl:value-of select="normalize-space(xa-resource-timeout)"/>
        </attribute>
      </xsl:if>
  ...
  <xsl:template name="generic-mcf">
    <depends optional-attribute-name="ManagedConnectionFactoryName">
      ...
      <mbean code="org.jboss.resource.connectionmanager.RARDeployment"
             ...
             display-name="ManagedConnectionFactory for ConnectionFactory {jndi-name}">
          ...
          <properties>
            ...
            <xsl:if test="user-name">
              <config-property name="UserName" type="java.lang.String">
                <xsl:value-of select="normalize-space(user-name)"/>
              </config-property>
            </xsl:if>
        ...
        <attribute name="RARName">
          <xsl:value-of select="rar-name"/>
        </attribute>
        <attribute name="ConnectionDefinition">
          <xsl:value-of select="connection-definition"/>
        </attribute>

        <depends optional-attribute-name="OldRarDeployment">jboss.jca:service=RARDeployment,name='<xsl:value-of
          select="rar-name"/>'
        </depends>
  ...
  <xsl:template match="config-property">
    <config-property name="{@name}" type="{@type}">
      <xsl:apply-templates/>
    </config-property>
  </xsl:template>
  ...
  <xsl:template name="local-wrapper">
    ...
    <depends optional-attribute-name="ManagedConnectionFactoryName">
      ...
      <mbean code="org.jboss.resource.connectionmanager.RARDeployment"
             name="jboss.jca:service=ManagedConnectionFactory,name={jndi-name}"
             display-name="ManagedConnectionFactory for DataSource {jndi-name}">
        ...
        <attribute name="RARName">
          <xsl:value-of select="jboss-local-jdbc.rar"/>
        </attribute>
        ...
        <attribute name="ManagedConnectionFactoryProperties">
          <properties>
            <config-property name="ConnectionURL" type="java.lang.String">
              <xsl:value-of select="normalize-space(connection-url)"/>
            </config-property>
            <config-property name="DriverClass" type="java.lang.String">
              <xsl:value-of select="normalize-space(driver-class)"/>
            </config-property>
  ...
  <xsl:template name="xa-wrapper">
    <depends optional-attribute-name="ManagedConnectionFactoryName">
      ...
      <mbean code="org.jboss.resource.connectionmanager.RARDeployment"
        ...
        <depends optional-attribute-name="OldRarDeployment">jboss.jca:service=RARDeployment,name='jboss-xa-jdbc.rar'
        </depends>
        <attribute name="RARName">
          <xsl:value-of select="jboss-xa-jdbc.rar"/>
        </attribute>
        <attribute name="ConnectionDefinition">javax.sql.DataSource</attribute>

        <attribute name="ManagedConnectionFactoryProperties">
          <properties>
            <config-property name="XADataSourceClass" type="java.lang.String">
              <xsl:value-of select="normalize-space(xa-datasource-class)"/>
            </config-property>
  ...
  <xsl:template name="wrapper-common-properties">
    ...
    <xsl:if test="transaction-isolation">
      <config-property name="TransactionIsolation" type="java.lang.String">
        <xsl:value-of select="normalize-space(transaction-isolation)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="user-name">
      <config-property name="UserName" type="java.lang.String">
    ...
    <xsl:if test="new-connection-sql">
      <config-property name="NewConnectionSQL" type="java.lang.String">
        <xsl:value-of select="normalize-space(new-connection-sql)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="check-valid-connection-sql">
      <config-property name="CheckValidConnectionSQL" type="java.lang.String">
        <xsl:value-of select="normalize-space(check-valid-connection-sql)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="valid-connection-checker-class-name">
      <config-property name="ValidConnectionCheckerClassName" type="java.lang.String">
        <xsl:value-of select="normalize-space(valid-connection-checker-class-name)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="exception-sorter-class-name">
      <config-property name="ExceptionSorterClassName" type="java.lang.String">
        <xsl:value-of select="normalize-space(exception-sorter-class-name)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="stale-connection-checker-class-name">
      <config-property name="StaleConnectionCheckerClassName" type="java.lang.String">
        <xsl:value-of select="normalize-space(stale-connection-checker-class-name)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="track-statements">
      <config-property name="TrackStatements" type="java.lang.String">
        <xsl:value-of select="normalize-space(track-statements)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="prepared-statement-cache-size">
      <config-property name="PreparedStatementCacheSize" type="int">
        <xsl:value-of select="normalize-space(prepared-statement-cache-size)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="share-prepared-statements">
      <config-property name="SharePreparedStatements" type="boolean">
        <xsl:value-of select="normalize-space(share-prepared-statements)"/>
      </config-property>
    </xsl:if>
    ...
    <xsl:if test="query-timeout">
      <config-property name="QueryTimeout" type="int">
        <xsl:value-of select="normalize-space(query-timeout)"/>
      </config-property>
    </xsl:if>
    <xsl:if test="url-delimeter">
      <config-property name="URLDelimeter" type="java.lang.String">
        <xsl:value-of select="normalize-space(url-delimeter)"/>
      </config-property>
    </xsl:if>
    <!-- new matching/background validation-->
    <xsl:choose>
      <xsl:when test="validate-on-match">
        <config-property name="ValidateOnMatch" type="boolean">
          <xsl:value-of select="normalize-space(validate-on-match)"/>
        </config-property>
      </xsl:when>
      <xsl:otherwise>
  ...
  <xsl:template name="pool">
    ...
    <depends optional-attribute-name="ManagedConnectionPool">
      ...
      <mbean code="org.jboss.resource.connectionmanager.JBossManagedConnectionPool"
             name="jboss.jca:service=ManagedConnectionPool,name={jndi-name}"
             display-name="Connection Pool for DataSource {jndi-name}">
        <xsl:choose>
        ...
        <xsl:choose>
          <xsl:when test="min-pool-size">
            <attribute name="MinSize">
              <xsl:value-of select="min-pool-size"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="blocking-timeout-millis">
            <attribute name="BlockingTimeoutMillis">
              <xsl:value-of select="blocking-timeout-millis"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="idle-timeout-minutes">
            <attribute name="IdleTimeoutMinutes">
              <xsl:value-of select="idle-timeout-minutes"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="background-validation">
            <attribute name="BackGroundValidation">
              <xsl:value-of select="background-validation"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="background-validation-minutes">
            <attribute name="BackGroundValidationMinutes">
              <xsl:value-of select="background-validation-minutes"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="prefill">
            <attribute name="PreFill">
              <xsl:value-of select="prefill"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="strict-min">
            <attribute name="StrictMin">
              <xsl:value-of select="strict-min"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
        ...
        <xsl:choose>
          <xsl:when test="statistics-formatter">
            <attribute name="StatisticsFormatter">
              <xsl:value-of select="statistics-formatter"/>
            </attribute>
          </xsl:when>
          <xsl:otherwise>
            <attribute name="StatisticsFormatter">
...
criteria indicates if Subject (from security domain) or app supplied
  ...
  <xsl:template name="cm-common">
    ...
    <xsl:if test="security-domain|security-domain-and-application">
      <attribute name="SecurityDomainJndiName">
        <xsl:value-of select="security-domain|security-domain-and-application"/>
      </attribute>
  ...
  <xsl:template name="ds-binding">
    ...
    <mbean code="org.jboss.resource.adapter.jdbc.remote.WrapperDataSourceService"
      ...
      <xsl:choose>
        <xsl:when test="use-java-context">
          <attribute name="UseJavaContext">
            <xsl:value-of select="use-java-context"/>
          </attribute>
        </xsl:when>
        <xsl:otherwise>
          <attribute name="UseJavaContext">true</attribute>
      ...
      <xsl:choose>
        <xsl:when test="jmx-invoker-name">
          <depends optional-attribute-name="JMXInvokerName">
            <xsl:value-of select="jmx-invoker-name"/>
          </depends>
        </xsl:when>
        <xsl:otherwise>
    ...
    <depends optional-attribute-name="ManagedConnectionFactoryName">
      ...
      <mbean code="org.jboss.resource.connectionmanager.RARDeployment"
        ...
        <depends optional-attribute-name="OldRarDeployment">
          jboss.jca:service=RARDeployment,name='jboss-ha-local-jdbc.rar'
        </depends>
        <attribute name="RARName">
          <xsl:value-of select="jboss-ha-local-jdbc.rar"/>
        </attribute>
        <attribute name="ConnectionDefinition">javax.sql.DataSource</attribute>
  ...
  <xsl:template name="ha-xa-wrapper">
    <depends optional-attribute-name="ManagedConnectionFactoryName">
      ...
      <mbean code="org.jboss.resource.connectionmanager.RARDeployment"
        ...
        <depends optional-attribute-name="OldRarDeployment">jboss.jca:service=RARDeployment,name='jboss-ha-xa-jdbc.rar'
        </depends>
        <attribute name="RARName">
          <xsl:value-of select="jboss-ha-xa-jdbc.rar"/>
        </attribute>
        <attribute name="ConnectionDefinition">javax.sql.DataSource</attribute>
        ...
        <attribute name="ManagedConnectionFactoryProperties">
          <properties>
            ...
            <xsl:if test="url-property">
              <config-property name="URLProperty" type="java.lang.String">
                <xsl:value-of select="normalize-space(url-property)"/>
              </config-property>
            </xsl:if>
