...
package org.granite.validation.constraints {
	 ...
	 * <code>javax.validation.constraints.Null</code> annotation
	 * validator.<p />
	 * 
	 * The annotated element must be <code>null</code>.<p />
	 * 
	 ...
	 * Example:<p />
	 * <listing>
	 * [Null(message="{my.custom.message}", groups="path.to.MyGroup1, path.to.MyGroup2")]
	 ...
	 * @author Franck WOLFF
	 */
	public class Null extends BaseConstraint {
		 ...
		 */
		public static const DEFAULT_MESSAGE:String = "{javax.validation.constraints.Null.message}";
