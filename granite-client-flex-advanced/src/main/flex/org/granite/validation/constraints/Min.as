...
package org.granite.validation.constraints {
	 ...
	 * <code>javax.validation.constraints.Min</code> annotation
	 * validator.<p />
	 * 
	 ...
	 * Example:<p />
	 * <listing>
	 * [Min(message="{my.custom.message}", groups="path.to.MyGroup1, path.to.MyGroup2", value="123")]
	...
	public class Min extends BaseConstraint {
		 ...
		 */
		public static const DEFAULT_MESSAGE:String = "{javax.validation.constraints.Min.message}";
