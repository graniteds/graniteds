...
package org.granite.validation.constraints {
	 ...
	 * <code>javax.validation.constraints.AssertFalse</code> annotation
	 * validator.<p />
	 * 
	 * The annotated element must be false.<p />
	 * 
	 ...
	 * @author Franck WOLFF
	 */
	public class AssertFalse extends BaseConstraint {
		...
		override public function validate(value:*):String {
			...
			return (value as Boolean ? message : null);
		}
	}
}