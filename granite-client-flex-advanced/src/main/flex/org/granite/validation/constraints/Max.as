...
package org.granite.validation.constraints {
	 ...
	 * <code>javax.validation.constraints.Max</code> annotation
	 * validator.<p />
	 * 
	 ...
	 * Example:<p />
	 * <listing>
	 * [Max(message="{my.custom.message}", groups="path.to.MyGroup1, path.to.MyGroup2", value="123")]
	...
	public class Max extends BaseConstraint {
		 ...
		 */
		public static const DEFAULT_MESSAGE:String = "{javax.validation.constraints.Max.message}";
		...
		override public function validate(value:*):String {
			...
			if (number == null || number.compareTo(new BigDecimal(_value)) > 0)
				return message;
