...
package org.granite.validation.constraints {
	 ...
	 * <code>javax.validation.constraints.AssertTrue</code> annotation
	 * validator.<p />
	 * 
	 * The annotated element must be true.<p />
	 * 
	 ...
	 * Example:<p />
	 * <listing>
	 * [AssertTrue(message="{my.custom.message}", groups="path.to.MyGroup1, path.to.MyGroup2")]
	 ...
	 * @author Franck WOLFF
	 */
	public class AssertTrue extends BaseConstraint {
		 ...
		 */
		public static const DEFAULT_MESSAGE:String = "{javax.validation.constraints.AssertTrue.message}";

		private static const ACCEPTED_TYPES:Array = BOOLEAN_TYPES;
		...
		override public function validate(value:*):String {
			...
			return (value as Boolean ? null : message);
		}
	}
}