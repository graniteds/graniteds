...
package org.granite.tide.impl {
	 ...
	 * 	@author William DRAI
	 */
	public class SimpleComponentProducer implements IComponentProducer {
		
		private var _implComponentName:String = null;
		
		public function SimpleComponentProducer(implComponentName:String):void {
		...
		public function get componentName():String {
   		...
   		public function produce(context:BaseContext, create:Boolean):Object {
   			return context.meta_getInstance(_implComponentName, create);
   		}		
	}
}
