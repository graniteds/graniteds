package org.granite.tide.ejb {
    ...
    public class EjbServerSession extends ServerSession {

        private static var log:ILogger = Log.getLogger("org.granite.tide.ejb.EjbServerSession");


        public function EjbServerSession(destination:String):void {
            super(destination);
        }
        ...
        public override function login(ctx:BaseContext, component:IComponent, username:String, password:String, responder:ITideResponder = null, charset:String = null):AsyncToken {
            ...
            token.addResponder(new ComponentResponder(this, ctx, ejbLoginSuccessHandler, ejbLoginFaultHandler, component, null, null, operation, false, responder, username));
