 ...
 * @author William Drai
 */
public class HazelcastTopicDestinationBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {

    @Override
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
    	builder.setLazyInit(false);
        
        mapOptionalAttributes(element, parserContext, builder, "id", "instance-name", "no-local", "session-selector");
    ...
    protected String getBeanClassName(Element element) {
        return "org.granite.hazelcast.spring.HazelcastTopicDestination";
    }
