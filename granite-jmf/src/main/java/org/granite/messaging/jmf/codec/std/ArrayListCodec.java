...
public interface ArrayListCodec extends BijectiveCodec<ArrayList<?>> {
	...
	void encode(OutputContext ctx, ArrayList<?> v) throws IOException;
	ArrayList<?> decode(InputContext ctx, int parameterizedJmfType) throws IOException, ClassNotFoundException;
}