...
public interface HashMapCodec extends BijectiveCodec<HashMap<?, ?>> {
	...
	void encode(OutputContext ctx, HashMap<?, ?> v) throws IOException;
	HashMap<?, ?> decode(InputContext ctx, int parameterizedJmfType) throws IOException, ClassNotFoundException;
}